 ...
 */
package org.rapidpm.vaadin.v10.tb.demo.components;
...
import static org.rapidpm.vaadin.v10.tb.demo.RolesToView.*;
import static org.rapidpm.vaadin.v10.tb.demo.components.HeaderComponent.componentIDGenerator;
...
public class HeaderComponentFactory implements HasLogger {
...

  {
    ...
    buttonMap.put(ROLE_A.roleName(), this::roleAButton);
  ...
  public static final String BTN_ROLE_A_ID = buttonID().apply(HeaderComponentFactory.class, ROLE_A.viewName());
  ...
  private Button roleAButton() {
    return new Button() {{
      setId(BTN_ROLE_A_ID);
      setText("role A");
      addClickListener(e -> UI.getCurrent().navigate(ROLE_A.viewName()));
    }};
  }
